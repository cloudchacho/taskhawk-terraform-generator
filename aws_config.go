...
// AWSScheduleItem struct represents a Taskhawk schedule for periodic jobs
type AWSScheduleItem struct {
...
// AWSQueueApp struct represents a Taskhawk consumer app
type AWSQueueApp struct {
...
// AWSConfig struct represents the Taskhawk configuration
type AWSConfig struct {
	QueueApps  []*AWSQueueApp `json:"queue_apps,omitempty"`
...
func (c *AWSConfig) validateConsumers() error {
...
func (c *AWSConfig) validateLambdaApps() error {
